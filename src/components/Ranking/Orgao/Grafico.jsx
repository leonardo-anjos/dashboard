...
export const RankingOrgaoGrafico =
...
// )(
  class extends Component {
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Select style={{ width: "100%" }} onChange={this.handleChange}>
                <Option value="maior">Min. Fazenda</Option>
                <Option value="menor">Casa da Moeda</Option>
              </Select>
            </Col>
            <Col span={12}>
    ...
    getSomaEstadoBem = async () => {
      ...
      this.setState({ somaEstadoBem: response.data.rows });
    }
